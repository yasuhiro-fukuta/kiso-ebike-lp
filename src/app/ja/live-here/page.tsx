  ...
  return (
    <div className="lp">
      ...
      <header className="page-head">
        ...
        <p>
          パンフレットには載せない話をひとつ。あなたにE-bikeを手渡しているこの人間も、最初は旅行者としてこの谷に来ました——そして、気づけば会社を辞めて家を引き払い、この谷に住んでいました。そしてこれは、実は私だけではありません。だから、川と旧街道の間のどこかで「ここに住んだらどんな感じだろう」とふと思ってしまったなら、それは変な考えではありません。住まいと働き口について、サポートできることがあります。
        </p>
      </header>
      ...
      <section className="drop-sec" id="pathway">
        <div className="drop-inner">
          ...
          <h2>
            おすすめするのは、<em>「段階的な移住」。</em>
          </h2>
          <p>
            移住成功の秘訣は、「移住前に人間関係を作る事」。定着した移住者の共通点であり、だいたい同じ3段階を踏んでいます。それをそのまま、サービスにしました。
          </p>
